        ...
        methods: {
            ...
            search() {
                ...
                search(this.query, this.page, this.showSinger, perpage).then( res => {
                    if (res.code === ERR_OK) {
                        this.result = this._getResult(res.list);
                        this.checkMore(res)
                    }
                })
            },
            searchMore() {
                ...
                search(this.query, this.page, this.showSinger, perpage).then( res => {
                    if (res.code === ERR_OK) {
                        this.result = this.result.concat(this._getResult(res.list));
                        this.checkMore(res)
                    }
                })
            },
            ...
            checkMore(data) {
                ...
                if (!list.length || (pageData.currnum + pageData.curpage * perpage)> pageData.totalnum) {
                    this.hasMore = false
                }
            },
            ...mapMutations({
